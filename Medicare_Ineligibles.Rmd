...
costplot <- costplot + stat_summary(fun.data="median_hilow",  geom="errorbar",width = 0.2,size=1.1)
...
```{r r insertyplots3, echo=FALSE, messages = FALSE, fig.width=6, fig.height=3}
