...
* Homogeneous mixing is assumed which means partnerships are not maintained from year to year. <!--- Big assumption but pretty much assumed forevery risk equation/ode model --->
...
if (!loadVars && !loadResults){
  ...
  heteroacts <- 0.6*c(60, 80, 100)     # Number of heterosexual acts per year with partners
  heterocondom <- c(0.15,0.225,0.3)   # Proportion of heterosexual acts where condoms have been used 
  gbmacts <- 0.6*c(20,40,60)           # Number of homosexual acts per year with partners
