...
totalplot <- ggplot(data = infectsSum, 
...
if (savePlots){
  dev.print(pdf, 
            file = paste(outputFolder, 
                         "/figures/", currTime, 
                         " Results_Sims", saveFileTag,".pdf",sep =""))
}
...
if (savePlots){
  dev.print(pdf,
            file = paste(outputFolder, "/figures/", currTime, 
                         "Results_Total", saveFileTag, ".pdf", sep = ""))
}
...
if (savePlots){
  ...
  dev.print(pdf,
            file = paste(outputFolder, "/figures/", currTime, 
                         " Results_Total-A", saveFileTag, ".pdf", 
                         sep = ""))
  windows(width = 6, height = 4.5)
  print(avertplot)
  dev.print(pdf, file = paste(outputFolder, "/figures/", currTime, 
                         " Results_Total-B", saveFileTag,
                         ".pdf", sep = ""))
}
