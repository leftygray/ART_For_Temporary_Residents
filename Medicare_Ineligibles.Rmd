...
if (!loadVars && !loadResults){
  ...
  timeTreat <- c(0,0)   # Time between infection and treatment where discounting would occur
...
if (!loadResults){
  ...
  for (ii in 1:nrow(newinfections)){
    ...
    simCostsDisc <-sum(discountcosts(lifecostYearly*costUncertainvec[newinfections$simulation[ii]], discRate,
                                                    newinfections$year[ii], timeTreatVec[newinfections$simulation[ii]]))
