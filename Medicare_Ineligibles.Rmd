...
newinfections$paramset <- t(paramSet) # Add parameterset number
newinfections <- newinfections[,c(ncol(newinfections),1:(ncol(newinfections)-1))] # Reorder: put paramset first
