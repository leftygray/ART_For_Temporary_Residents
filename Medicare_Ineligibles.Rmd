...
opts <- theme(text = element_text(face = "bold",size=16,colour="black"),
  axis.text.x = element_text(face = "plain",size=14,colour="black"),
...
simsplot <- ggplot(data = newinfections,aes(x=year,group=simulation)) # Setup data for plot
...
# Create a boxplot
totalplot <- ggplot(infectsSum,aes(x=scenario,y=newinfections)) + geom_boxplot()
