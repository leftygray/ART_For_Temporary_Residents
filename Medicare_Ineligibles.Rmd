...
if (!loadVars && !loadResults){
  ...
  # Proportion heterosexual is calculated internally so that the proportions add up to 1.
  ...
  # From Karen's Prep paper
  costFirst <- 10685
  costSecond <- 19364
  costThird <- 31411
  costFourh <- 28162
  
  # Weighted total cost for lifetime of treatment
  lifecost <- yearsFirst*costFirst + yearsSecond*costSecond + yearsThird*costThird + yearsFourth*costFourth
  lifecostRange <- c(0.75*lifeCost,1.25*lifeCost) # Undiscounted lifetime cost of ART 
...
$\pi$ | Multiplicative change in annual population | [`r pop_growth[1]` - `r pop_growth[3]`]/yr | 1            
$p_f$ | Proportion of Medicare-ineligible population of PLHIV who are female | [`r prop_f[1]` - `r prop_f[3]`] | 1
$p_m$ | Proportion of Medicare-ineligible population of PLHIV who are heterosexual male |  [`r prop_m[1]` - `r prop_m[3]`] | 1  
$p_g$ | Proprtion of Medicare-ineligible population of PLHIV who are MSM | Given by $1-p_f-p_m$ | 1  
**Clinical parameters** | | | 
