...
# Undiscounted costs
summaryResults[4, ] <- c("Cost providing care and ART (undiscounted)", 
  "NA",
  FormatData(medacost, 
             medacost-iqracost/2, 
             medacost+iqracost/2, 
...
summaryResults[6, ] <- c("Reduction in lifetime care and ART costs (undiscounted)", 
  "NA",
...
# Discounted costs
summaryResults[7, ] <- c("Cost providing care and ART (discounted 5%)", 
  "NA",
...
summaryResults[9, ] <- c("Reduction in lifetime care and ART costs (discounted 5%)",
  "NA",
