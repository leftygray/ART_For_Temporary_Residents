...
$$\sum_{y = 1}^{years} (N(y)(c_{care} + \theta c_{ART})\right$$
...
**Figure 1** - Annual new infections in partners of Medicare ineligibles for each simulation. The grey lines represent the baseline simulations while the blue lines are fro the expansion of ART to all Medicare ineligibles. The black and dark blue lines show the median number of new infections for the Baseline and expanded ATRAS simulations respectively.   
