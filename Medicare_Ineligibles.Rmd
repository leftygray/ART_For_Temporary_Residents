...
where $y_{ART}$ is the number of years infected people will be on ART, $c_{ART}(l)$ is the annual cost of ART $l$ years from initiation, and $t_i$ is the time between infection initiating ART. 
