...
loadFileTag <- "" # Set to empty to run things a fresh. Manually enter file name tag to regenerate old results. 
...
loadResults <- FALSE # Set to FALSE to run things a fresh. If TRUE a corresponding input file needs to exist and is loaded as well.
useSeed <- FALSE  # Use seed in loadVars file to get exactly the same results.

saveFileTag <- ""  # Tag for output file names to specify scenarios
...
knitplots <- FALSE  # Insert plots in the produced Rmarkdown document
...
if (!loadVars || !loadResults){
  ...
  numsims <- 100  # Number of sampled parameter sets to run
