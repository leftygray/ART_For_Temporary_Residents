...
output:
  word_document:
    ...
    pandoc_args: [--output="./output/Medicare_Ineligbles.docx"]
...
heteroactsVec <- mrunif(numsims,heteroacts[1],heteroacts[3])
...
for (ii in 1:numsims){
  ...
  infectsm[ii,] <- popinfects(popsizeMatrix[ii,]*prop_mMatrix[ii,1],infect_prob(heteroactsMatrix[ii,1],heterocondomMatrix[ii,1],
                  epsilon_condomMatrix[ii,1],prop_art_baseMatrix[ii,],prop_vs_baseMatrix[ii,],epsilon_artMatrix[ii,1],
                  betafMatrix[ii,1]),TRUE)
