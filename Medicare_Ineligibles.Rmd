...
colourmap <- c("#999999","#000000", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7") # Colour blind palette


graphics.off()
g <- ggplot(newinfections,aes(x=year,y=totalinfects,group=simulation)) + geom_line(color=colourmap[8])
# g <- g + geom_line(aes(y = totalinfectsbase,group=simulation,color=colourmap[2]))
# g <- g + theme_bw()
